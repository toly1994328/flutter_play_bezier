...
/// 说明: 贝塞尔曲线测试画布
class CircleBezierClipPage extends StatefulWidget {
  @override
  _CircleBezierClipPageState createState() => _CircleBezierClipPageState();
}

class _CircleBezierClipPageState extends State<CircleBezierClipPage> {
...
//        pos.map((e) => e.translate(-size.width / 2, -size.height / 2)).toList();
    ...
    _clipPath.addOval(Rect.fromCenter(center: Offset(330, -60),width: 150,height: 150));
...
//    canvas.drawPath(_clipPath, _mainPaint);
    canvas.drawPath(drawPath, _mainPaint
      ..style=PaintingStyle.fill..color=Color(0xffA7B1B7)
    );
    _drawHelp(canvas);
